...
{
    public class TCInputModule : PointerInputModule
    {
        [Tooltip("Object which points with Z axis. E.g. CentreEyeAnchor from OVRCameraRig")]
        public Transform rayTransform;

        //[Tooltip("Gamepad button to act as gaze click")]
        //public TCInput.Button joyPadClickButton = OVRInput.Button.One;
        ...
        [NonSerialized]
        public TCRaycaster activeGraphicRaycaster;
        [Header("Dragging")]
        ...
        protected void CopyFromTo(TCRayPointerEventData @from, TCRayPointerEventData @to)
        {
        ...
        protected Dictionary<int, TCRayPointerEventData> m_VRRayPointerData = new Dictionary<int, TCRayPointerEventData>();


        protected bool GetPointerData(int id, out TCRayPointerEventData data, bool create)
        {
            if (!m_VRRayPointerData.TryGetValue(id, out data) && create)
            {
                data = new TCRayPointerEventData(eventSystem)
                {
                    pointerId = id,
                };
        ...
        protected MouseState GetGazePointerData()
        {
            ...
            TCRayPointerEventData leftData;
            ...
            TCRaycaster ovrRaycaster = raycast.module as TCRaycaster;
            ...
            TCRayPointerEventData rightData;
            GetPointerData(kMouseRightId, out rightData, true);
            CopyFromTo(leftData, rightData);
            rightData.button = PointerEventData.InputButton.Right;

            TCRayPointerEventData middleData;
        ...
        private bool ShouldStartDrag(PointerEventData pointerEvent)
        {
            ...
            if (pointerEvent as TCRayPointerEventData == null)
            {
        ...
        {
            TCRayPointerEventData rayPointerEventData = pointerEvent as TCRayPointerEventData;
