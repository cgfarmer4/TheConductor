...
public class TCRaycaster : GraphicRaycaster, IPointerEnterHandler
{
    [Tooltip("A world space pointer for this canvas")]
    public GameObject pointer;


    protected TCRaycaster()
    { }
    ...
    {
        TCRayPointerEventData rayPointerEventData = eventData as TCRayPointerEventData;
    ...
    {
        TCInputModule inputModule = EventSystem.current.currentInputModule as TCInputModule;
        return inputModule && inputModule.activeGraphicRaycaster == this;
    }

    public void OnPointerEnter(PointerEventData e)
    {
        PointerEventData ped = e as TCRayPointerEventData;
        if (ped != null)
        {
